...
public class PetFriendsTransporteMessageConfig {
    ...
    public JacksonPubSubMessageConverter estadoMudouConverter() {
        ...
        simpleModule.addSerializer(PedidoEntregue.class, new PedidoEntregueSerializer());
        simpleModule.addDeserializer(PedidoEntregue.class, new PedidoEntregueDeserializer());
    ...
    public PubSubInboundChannelAdapter inboundChannelAdapter(
        ...
        PubSubInboundChannelAdapter adapter = new PubSubInboundChannelAdapter(pubSubTemplate, "PetFriends_Transportes");
        adapter.setOutputChannel(messageChannel);
        adapter.setAckMode(AckMode.MANUAL);
        adapter.setPayloadType(PedidoEntregue.class);
        return adapter;
    }
}
